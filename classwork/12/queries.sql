...
select * from users;
begin;
update users set lastname = '123123123' where id = 2;
select * from users;
rollback;
select * from users;
begin;
...
commit;
select * from users;
select id, name, overlay(lastname PLACING 'asd' FROM 0 FOR 2) from users;
select id, name, overlay(lastname PLACING 'asd' FROM 1 FOR 2) from users;
select id, name, overlay(lastname PLACING 'asd' FROM 1) from users;
\q
\s ./queries.sql
